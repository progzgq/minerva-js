...
function stringify(expression: any): string {
...
function stringifyObjectExpression(
  ...
  return objectExpression.toString();
...
function needsParenthesizing(expression: ESTree.Expression|ESTree.PrivateName): boolean {
